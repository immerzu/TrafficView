...
Kanonischer Tooling-Sammelordner ist jetzt `F:\001_Coding_Projekte\TrafficView_Moi\Tooling`. Die alten Top-Level-Namen `Hilfsprogramme` und `Zusatz_Tools` bleiben nur noch als versteckte Kompatibilitaets-Junctions bestehen.
...
- Einsicht in Projektdateien wie [`build.ps1`](F:\001_Coding_Projekte\TrafficView_Moi\TrafficView\build.ps1)
...
| ComfyUI | Zusatzsoftware | Nachinstalliert / eingerichtet | `0.18.2` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI\ComfyUI` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI\ComfyUI\main.py` | lokale Portable-Installation, jetzt zentral unter `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI`; alte Pfade bleiben ueber versteckte Kompatibilitaets-Junctions erreichbar | Zentrale Bildgenerierung und `img2img` für TrafficView-Skins | Ja, bevorzugt |
| ComfyUI Embedded Python | Zusatzsoftware | Mit ComfyUI installiert / verwendet | `3.13.11` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI\python_embeded` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI\python_embeded\python.exe` | Bestandteil der ComfyUI-Installation, lokal per `--version` geprüft | Bevorzugte Laufzeit zum Starten von ComfyUI | Ja |
...
| SDXL Base 1.0 Checkpoint | Modellpaket | Verwendet | unbekannt | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models\checkpoints` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models\checkpoints\sd_xl_base_1.0.safetensors` | lokal vorhanden; Download-Herkunft in dieser Datei nicht sicher feststellbar | Hauptmodell für Skin-Rendering in ComfyUI | Ja |
| SDXL VAE | Modellpaket | Verwendet / vorhanden | unbekannt | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models\vae` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models\vae\sdxl_vae.safetensors` | lokal vorhanden; Download-Herkunft nicht sicher feststellbar | VAE für SDXL-Decoding in ComfyUI | Ja |
| ControlNet Canny | Modellpaket | Nachinstalliert / vorhanden | unbekannt | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models\controlnet` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models\controlnet\control_v11p_sd15_canny_fp16.safetensors` | im Projektverlauf nachinstalliert; genaue Downloadquelle hier nicht verifiziert | Für künftige Kanten-/Konturstabilisierung bei Skin-Arbeit vorgesehen | Ja |
| TrafficView Model Path Mapping | Hilfskonfiguration | Nachinstalliert / eingerichtet | unbekannt | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI\ComfyUI` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI\ComfyUI\extra_model_paths.yaml` | lokal angelegt, Inhalt geprüft | Bindet zentrale Modellordner (`checkpoints`, `vae`, `loras`, `controlnet`) in ComfyUI ein | Ja |
| Inno Setup Compiler Einstieg | Zusatzsoftware | Eingerichtet / vorhanden | `6.7.1` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\InnoSetup` | `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\InnoSetup\ISCC.cmd` | Wrapper auf lokal installierte Inno-Setup-Binary unter `%LOCALAPPDATA%` | Nur noch historisch fuer alte Installer; nicht Teil des aktiven Portable-Release-Ablaufs | Nein |
...
- `IPAdapter`-Modelle:
  - geprüft über `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models\ipadapter`
...
1. Für Skin-Erzeugung zuerst ComfyUI unter `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\ComfyUI` prüfen und wiederverwenden.
2. Modelle zuerst unter `F:\001_Coding_Projekte\TrafficView_Moi\Tooling\Graphics\Models` suchen, bevor neue Downloads begonnen werden.
3. Zusätzliche Software für dieses Projekt künftig bevorzugt unter `F:\001_Coding_Projekte\TrafficView_Moi\Tooling` ablegen.
4. Bereits vorhandene Workflow-Helfer aus dem historischen Grafikhilfen-Bestand vor Wiederverwendung lokal verifizieren.
5. TrafficView weiterhin über [`build.ps1`](F:\001_Coding_Projekte\TrafficView_Moi\TrafficView\build.ps1) und `csc.exe` bauen, nicht primär über `dotnet`.
